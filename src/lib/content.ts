...
import charactersIndex from "../../content/characters.json";
import type { Character, CharacterIndex, SeriesIndex, Volume } from "./types";
...
export function getCharacterIndex(): CharacterIndex {
  return charactersIndex as CharacterIndex;
}
...
export function getCharacterBySlug(slug: string): Character | undefined {
  return getAllCharacters().find((character) => character.slug === slug);
}
